...
public class BlankEmailStepD {
    ...
    public static WebDriver driver = BaseTest.driver;
        ...
        @When("^customer enter the \"([^\"]*)\" and \"([^\"]*)\"$")
        public void iEnterTheAnd(String BlankEmail, String Password) throws Throwable {
            driver.findElement(By.xpath("//*[@id='Email']")).sendKeys(BlankEmail);
        ...
        public void iClickOnToTheLOGINButton() throws Throwable {
            ...
            System.out.println("i enter blankemail and password");
        }

        @Then("^customer should able to see error message \"([^\"]*)\"$")
